...
export default function NotFoundPage() {
  return (
    <section className="flex items-center justify-center min-h-screen py-48 bg-black">
      <div className="flex flex-col">
        <div className="flex flex-col items-center">
          <div className="text-indigo-500 font-bold text-7xl">404</div>

          <div className="font-bold text-3xl text-gray-400 xl:text-7xl lg:text-6xl md:text-5xl mt-10">
          ...
          <div className="flex flex-col items-stretch mt-5">
            ...
            >
              ...
              <div className="grow flex flex-col pl-5 pt-2">
                <Link
                  className="font-bold text-sm md:text-lg text-white lg:text-xl group-hover:underline"
                  to="/"
                >
                  Home Page
                </Link>
            ...
            >
              ...
              <div className="grow flex flex-col pl-5 pt-2">
                <Link
                  className="font-bold text-sm md:text-lg lg:text-xl text-white group-hover:underline"
                  to="menu"
                >
                  Menu
                </Link>
